...
.main {
  ...
  height: 480px;
  position: relative;
  background: url(../../public/img/circle/53bg2.png) no-repeat;
...
.main .total {
  ...
  .cicle3 {
    width: 100%;
    height: 35rem;
    background: url(../../public/img/circle/circle.png) no-repeat center;
  ...
  .cicle4 {
    ...
    left: 50%;
    transform-style: preserve-3d;
    background: url(../../public/img/circle/53gqright.png) no-repeat center;
    background-size: 100%;
    transform: translateX(-50%) rotateX(75deg);
  ...
  .cicle8 {
    background: url(../../public/img/circle/circle1.png) no-repeat;
    background-size: 100%;
  ...
  .cicle9 {
    background: url(../../public/img/circle/circle2.png) no-repeat;
    background-size: 100%;
